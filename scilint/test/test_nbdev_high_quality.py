# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/example_nbs/test_nbdev_high_quality.ipynb.
...
# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 3
def echo(message):
    return message

# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 7
import numpy as np
import pandas as pd

# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 9
traffic_percent = 1
workers = 8
model_level = "dispatcher"
min_date = "2021-01-01"

# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 10
def get_traffic_text(percent):
    return str(percent) if int(percent) >= 10 else "0" + str(percent)

# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 14
def get_experiment_segment(traffic_percent):
    return tuple(get_traffic_text(tp) for tp in range(traffic_percent))

# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 16
...
# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 18
...
# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 21
class Topics:
...
# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 23
def fit(documents, workers=workers):
    model = Topics(documents, workers=workers)
    results = {"model": model}
    return results

# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 35
def evaluate(model):
...
# %% ../../nbs/example_nbs/test_nbdev_high_quality.ipynb 38
