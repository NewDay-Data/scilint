# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/example_nbs/exploratory/nbdev.ipynb.
...
# %% ../../nbs/example_nbs/exploratory/nbdev.ipynb 2
def something():
...
# %% ../../nbs/example_nbs/exploratory/nbdev.ipynb 18
...
# %% ../../nbs/example_nbs/exploratory/nbdev.ipynb 21
class Topics:
...
# %% ../../nbs/example_nbs/exploratory/nbdev.ipynb 23
def fit(documents, workers=workers):
    model = Topics(documents, workers=workers)
    results = {"model": model}
    return results

# %% ../../nbs/example_nbs/exploratory/nbdev.ipynb 35
def evaluate(model):
...
# %% ../../nbs/example_nbs/exploratory/nbdev.ipynb 38
