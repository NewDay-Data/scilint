...
# %% auto 0
__all__ = ['indicator_funcs', 'calls_per_func', 'calls_per_func_mean', 'calls_per_func_median', 'iaf', 'tests_per_function',
           'tests_per_func_mean', 'tests_func_coverage_pct', 'calc_ifp', 'in_func_pct', 'markdown_code_pct',
           'total_code_len', 'loc_per_md_section']
